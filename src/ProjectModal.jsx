...
export default function ProjectModal({ project, onClose }) {
  ...
  return (
    ...
    >
      <div 
        className="bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl max-w-3xl w-full max-h-[85vh] overflow-y-auto relative"
